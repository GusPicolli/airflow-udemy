...
from include.stock_market.tasks import _get_stock_prices, _store_prices, _get_formatted_csv, _load_to_dw, BUCKET_NAME
SYMBOL = 'NVDA'
...
def stock_market():
    ...
    load_to_dw = PythonOperator(
        ...
        op_kwargs={
            'csv_object_name': '{{ ti.xcom_pull(task_ids="get_formatted_csv") }}'
        }
    )
